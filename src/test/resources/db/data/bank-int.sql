...
insert into bank_account (LAST_NAME , FIRST_NAME , BALANCE) values ('walter','white',4000);
insert into bank_account (LAST_NAME , FIRST_NAME , BALANCE) values ('danerys','targaryan',4000);
insert into bank_account (LAST_NAME , FIRST_NAME , BALANCE) values ('arya','stark',4000);